...
export default async function TermsPage({
  ...
  const content = await loadPageContent("terms", isEditMode);
  ...
  return (
    <PageShell>
      ...
      {content.isEditMode ? <EditModeOverlay currentPath="/terms?edit=1" /> : null}
    </PageShell>
  );
}
