    ...
    >
      ...
      <div className="flex items-center justify-end pt-2 border-t border-faint">
        <button
          ...
          disabled={isPending}
          aria-busy={isPending}
          className="inline-flex items-center justify-center bg-orange hover:brightness-105 text-ink font-display font-semibold text-sm px-6 py-3 rounded-md transition disabled:opacity-60 disabled:cursor-not-allowed"
        >
